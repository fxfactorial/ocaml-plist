...
(* OASIS_START *)
(* DO NOT EDIT (digest: 15ea507fc7367778acde1fb09f8c0a60) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_plist", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fxfactorial/ocaml-plist";
          synopsis = "Create Apple Plists";
          description = Some [OASISText.Para "Create Apple plists"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "plist";
                           FindlibPackage ("alcotest", None);
                           FindlibPackage ("osx-plutil", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "plist_test.ml"});
               Test
                 ({
                     cs_name = "test_parse_print";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ó»‰R\000\147#\016i2\nY]\028{µ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
